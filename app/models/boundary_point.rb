class BoundaryPoint < ActiveRecord::Base
  ...
  validates_uniqueness_of :latitude, :scope => [:area_id, :longitude], :message => 'Boundary Point must have unique latitude-longitude for this area.'
